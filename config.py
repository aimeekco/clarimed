...
class HealthGPTConfig_XL32_COM:
    ...
    hlora_nums = 4
    vq_idx_nums = 8192
    instruct_template = "qwen_instruct"
    vit_path = "./clip-vit-large-patch14-336/"
    hlora_path = "./HealthGPT-XL32/com_hlora_weights_QWEN_32B.bin"
    fusion_layer_path = None
    do_sample = False
    temperature = 0.0
    top_p = None
...
class HealthGPTConfig_XL32_GEN:
    model_name_or_path = "./Qwen2.5-32B-Instruct"
    dtype = "FP16"
    attn_implementation = None
    hlora_r = 256
    ...
    instruct_template = "qwen_instruct"
    vit_path = "./clip-vit-large-patch14-336/"
    hlora_path = "./HealthGPT-XL32/gen_hlora_weights_QWEN_32B.bin"
    fusion_layer_path = "./HealthGPT-XL32/fusion_layer_weights_QWEN_32B.bin"
    do_sample = False
    temperature = 0.0
    top_p = None
    num_beams = 1
